...
public class fSimulator {
	...
	public static void main(String[] args) {
		...
		//creating dummy yield data for ss yc 16
		gY.addMetricValue( 	0, "yCFVol"	);
		gY.addMetricValue( 	21, "yCFVol"	);
		gY.addMetricValue( 	30.8, "yCFVol");
		gY.addMetricValue( 	40.6, "yCFVol");
		gY.addMetricValue( 	50.4, "yCFVol");
		gY.addMetricValue( 	60.2, "yCFVol");
		gY.addMetricValue( 	70, "yCFVol"	);
		gY.addMetricValue( 	70, "yCFVol"	);
		gY.addMetricValue( 	87, "yCFVol"	);
		gY.addMetricValue( 	104, "yCFVol"	);
		gY.addMetricValue( 	121, "yCFVol"	);
		gY.addMetricValue( 	138, "yCFVol"	);
		gY.addMetricValue( 	155, "yCFVol"	);
		gY.addMetricValue( 	172, "yCFVol"	);
		gY.addMetricValue( 	169, "yCFVol"	);
		gY.addMetricValue( 	204.5, "yCFVol");
		gY.addMetricValue( 	240, "yCFVol"	);
		gY.addMetricValue( 	275.5, "yCFVol");
		gY.addMetricValue( 	311, "yCFVol"	);
		gY.addMetricValue( 	346.5, "yCFVol");
		gY.addMetricValue( 	382, "yCFVol"	);
		gY.addMetricValue( 	382, "yCFVol"	);
		gY.addMetricValue( 	274, "yCFVol"	);
		gY.addMetricValue( 	319.4, "yCFVol");
		gY.addMetricValue( 	364.8, "yCFVol");
		gY.addMetricValue( 	410.2, "yCFVol");
		gY.addMetricValue( 	455.6, "yCFVol");
		gY.addMetricValue( 	501, "yCFVol"	);
		gY.addMetricValue( 	0, "yCFVol"	);
